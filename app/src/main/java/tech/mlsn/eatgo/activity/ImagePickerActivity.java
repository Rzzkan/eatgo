...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.red_apple));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.red_apple));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.red_apple));
